...
func (m *PostTransactionsWrapper) validateTransaction(formats strfmt.Registry) error {
...
func (m *PostTransactionsWrapper) validateTransactions(formats strfmt.Registry) error {
...
func (m *PostTransactionsWrapper) contextValidateTransaction(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostTransactionsWrapper) contextValidateTransactions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostTransactionsWrapper) UnmarshalBinary(b []byte) error {
	var res PostTransactionsWrapper
